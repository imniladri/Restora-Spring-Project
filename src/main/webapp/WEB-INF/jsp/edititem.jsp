...
<head>
    <title>Edit Menu Item | Restora</title>
...
<body>
    ...
    <section id="deleteModal">
        <div class="deleteModal">
            ...
            <p>This item will be removed from Restora Menu.</p>
            <a href="/editFoodItem/deleteItem/${deleteFoodItemId}" class="btn">Confirm Delete<i class="bx bx-trash"></i></a>
    ...
    <section id="newitem">
        <div class="newitem">
            ...
            <h2><span>Edit Food</span> Item</h2>
            <p>Admin, want to edit item details?</p>

            <form:form action="updateItem" method="POST">
                ...
                <div class="form_group col-12">
                    <form:input type="text" class="form-control" id="foodItemId" name="foodItemId" path="foodItemId" value="${item.foodItemId}" readonly="true" />
                </div>

                <div class="form_group col-12">
                    <form:label for="foodItemName" path="foodItemName" class="form-label">Food Name <i>*</i></form:label>
                    <form:input type="text" class="form-control" id="foodItemName" name="foodItemName" path="foodItemName" value="${item.foodItemName}" />
                </div>

                <div class="form_group col-12">
                    <form:label for="foodItemDesc" path="foodItemDesc" class="form-label">Food Description <i>*</i></form:label>
                    <form:input type="text" class="form-control" id="foodItemDesc" name="foodItemDesc" path="foodItemDesc" value="${item.foodItemDesc}" />
                </div>

                <div class="form_group col-12">
                    <form:label for="foodItemImageSrc" path="foodItemImageSrc" class="form-label">Food Image Source (Food Name) <i>*</i></form:label>
                    <form:input type="text" class="form-control" id="foodItemImageSrc" name="foodItemImageSrc" path="foodItemImageSrc" placeholder="/resources/assets/img/items/[type_food_image_name]" value="${item.foodItemImageSrc}" />
                </div>

                <div class="form_group col-12">
                    <form:label for="foodItemPrice" path="foodItemPrice" class="form-label">Food Price <i>*</i></form:label>
                    <form:input type="text" class="form-control" id="foodItemPrice" name="foodItemPrice" path="foodItemPrice" value="${item.foodItemPrice}" />
                </div>
                ...
                <div class="form_group col-12">
                    ...
                    <form:input type="text" class="form-control" id="foodItemCategory" name="foodItemCategory" path="foodItemCategory" value="${item.foodItemCategory}" />
                </div>

                <button type="submit" id="submit" class="btn">Update Menu Item</button>
                <a href="javascript:void()" id="confirmDelete" class="deletebtn btn">Delete Item</a>
