...
<head>
    <title>Order Placed | Restora</title>
    ...
    <link rel="stylesheet" href="<c:url value='/resources/css/pages/payment.css'/>" />
...
<body>
    ...
    <section id="payment_status">
        <div class="payment_status">
            ...
            <p>Your order has been placed successfully! You can now track all your orders.</p>
