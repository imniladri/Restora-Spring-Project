...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/resources/css/pages/cart.css'/>" />
...
<body>
    ...
    <section id="cart">
        <div class="cart">
            ...
            <p>One last step to get your foodies...</p>
                ...
                <c:choose>
                    <c:when test="${cartItemList.size() > 0}">
                        ...
                        <c:forEach items="${cartItemList}" var="cartItem">
                            ...
                            <div class="item_row">
                                <div class="item_col col-md-5 col-12">
                                    <div class="item_img">
                                        <img src="<c:url value='/resources/assets/img/items/${cartItem.item.foodItemImageSrc}'/>" alt="">
                                    </div>
                                    <div class="item_desc">
                                        <h4>${cartItem.item.foodItemName}</h4>
                                        <p>${cartItem.item.foodItemDesc}</p>
                                    </div>
                                </div>
                                <div class="item_col col-md-2 col-2">
                                    <div class="item_price">
                                        <h4><i class="bx bx-rupee"></i><span>${cartItem.item.foodItemPrice}</span></h4>
                                    </div>
                                </div>
                                <div class="item_col col-md-2 col-2">
                                    <div class="item_counter">
                                        <a class="btn" href="/updateCartLess/${cartItem.item.foodItemId}">
                                            <i class="bx bx-minus"></i>
                                        </a>
                                        <span>${cartItem.quantity}</span>
                                        <a class="btn" href="/updateCartMore/${cartItem.item.foodItemId}">
                                ...
                                <div class="item_col col-md-2 col-2">
                                    <div class="item_price">
                                        <h4><i class="bx bx-rupee"></i><span>${cartItem.quantity * cartItem.item.foodItemPrice}</span></h4>
                                    </div>
                                </div>
                                <div class="item_col col-md-1">
                                    <a class="item_delete btn" href="/removeCart/${cartItem.item.foodItemId}">
                        ...
                        <div class="cart_total">
                            <h4>Your Cart Total: <i class="bx bx-rupee"></i><span>${cartTotalPrice}</span></h4>
                    ...
                    <c:otherwise>
                        <div class="cart_empty">
                            ...
                            <a class="btn" href="/menu">Add Items</a>
                        </div>
                    </c:otherwise>
